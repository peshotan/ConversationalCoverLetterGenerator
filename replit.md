...
- PDF resume input is processed in the browser; pasted text remains the source of truth.
- The first server generator is deterministic and evidence-based so the product remains usable without a model key.
